...
>
	<div class="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 md:px-10">
		<div class="flex items-center gap-4">
			...
			<div>
				<p class="text-xs font-semibold uppercase tracking-[0.45em] text-accent">NotiAir</p>
				<p class="text-xs uppercase tracking-[0.3em] text-muted">Notification Service</p>
			</div>
		</div>

		<div class="flex items-center gap-3">
			<a href="/channels" class="btn-primary hidden md:inline-flex">Channels</a>
			<a href="/workflows" class="btn-primary hidden md:inline-flex">Workflow</a>
			<span class="pill hidden md:inline-flex">beta</span>
...
<main class="px-4 pb-12 pt-2 md:px-12 md:pt-4">
